...
#Step3: Draw Circles at the Centers of Both Rectangles
...
#Step 4: Draw Connecting Lines Bteween Centers of Rectangles
cv2.line(image_rgb, (center1_x, center1_y), (center2_x, center2_y), (0, 255, 255), 2, cv2.LINE_AA)
...
cv2.arrowedLine(image_rgb, arrow_end, arrow_start, (255, 255, 0), 3, tipLength=0.05)#Downward arrow
