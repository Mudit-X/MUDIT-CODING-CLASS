...
def generate_image_from_text(prompt: str) -> Image.Image:
    ...
    payload = {"inputs": prompt}  # ✅ Correct dictionary syntax
    
    try:
        response = requests.post(API_URL, headers=headers, json=payload, timeout=30)  # ✅ Correct named arguments
...
def main():
    ...
    while True:
        ...
        try:
            ...
            if save_option == "yes":  # ✅ Correct comparison
                ...
                image.save(f"{file_name}.png")  # ✅ Correct f-string
