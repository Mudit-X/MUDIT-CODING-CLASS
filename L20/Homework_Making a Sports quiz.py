...
# Trivia API endpoint for Sports category (category=21)
url = "https://opentdb.com/api.php?amount=5&category=21&type=multiple"  # Fetch 5 sports questions
...
if response.status_code == 200:
    ...
    for i, question_data in enumerate(trivia_data["results"]):
        ...
        options = sorted(options)  # Alphabetical order like in your example
